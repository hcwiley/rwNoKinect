...
public class Controls {
  ...
  public rwNoKinect parent;

  public Controls(rwNoKinect par) {
    parent = par;
  }
  void setParameters() {
    parent.n = 10000;
  ...
  void makeControls() {
    ...
    256, 9).setWindow(w);
    control.addToggle("paused", false, 10, y += 15, 9, 9).setWindow(w);
    ...
    y += 15, 256, 9).setWindow(w);
    control.addSlider("blocksize", (float)0, (float)130, (float)parent.blocksize, 10, 
    y += 15, 256, 9).setWindow(w);
